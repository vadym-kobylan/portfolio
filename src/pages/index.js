  ...
  return (
    <>
      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
          ...
          <div className="flex items-center justify-beetwen w-full">
            ...
            <div className="w-1/2 flex flex-col items-center self-center">
              ...
              <div className="flex items-center self-start mt-2">
                ...
                dark:bg-light dark:text-dark dark:hover:text-light dark:hover:border-light dark:hover:bg-dark"
                  download={true}>
        ...
        <HireMe />
        <div className="absolute right-9 bottom-8 inline-block w-24">
